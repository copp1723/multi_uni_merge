...
def test_service_registry():
    ...
    try:
        from utils.service_utils import BaseService, ServiceRegistry, ServiceStatus, ServiceHealth
...
def test_swarm_orchestrator():
    ...
    try:
        ...
        comm_agent = next((agent for agent in agents if agent["id"] == "communication"), None)
        ...
        assert status["total_agents"] >= 6  # Should have at least 6 agents including Communication Agent
